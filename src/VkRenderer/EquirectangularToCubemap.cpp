...
namespace cdm
{
struct EquirectangularToCubemapVertex
{
	vector3 position;
};

struct EquirectangularToCubemapPushConstant
{
	matrix4 matrix;
};

EquirectangularToCubemap::EquirectangularToCubemap(RenderWindow& renderWindow,
...
#pragma region fragmentShader
	{
		...
		auto invAtan =
		    writer.declConstant("invAtan", vec2(0.1591_f, 0.3183_f));
...
#pragma region pipeline layout
	...
	pcRange.size = sizeof(EquirectangularToCubemapPushConstant);
...
#pragma region pipeline
	...
	binding.stride = sizeof(EquirectangularToCubemapVertex);
...
Cubemap EquirectangularToCubemap::computeCubemap(
...
#pragma region cubemap
	Cubemap cubemap(
	    ...
	    VMA_MEMORY_USAGE_GPU_ONLY, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
	vk.debugMarkerSetObjectName(cubemap.image(), VK_DEBUG_REPORT_OBJECT_TYPE_IMAGE_EXT, "cubemap");
...
#pragma endregion
	...
	EquirectangularToCubemapPushConstant pc;
